...
class Villa(DateTimeFields):
    ...
    name = models.CharField(
        help_text="연립/다세대 이름", null=False, blank=False, max_length=30
    )
    ...
    broker_address = models.CharField(
        help_text="중개업소 주소(중개사소재지)", null=True, blank=True, max_length=30
    )
    road_name_address = models.CharField(
        help_text="도로명 주소", null=False, blank=False, max_length=30
    )
    ...
    price_per_pyung = models.CharField(
        help_text="평당가", null=False, blank=False, max_length=8
    )
